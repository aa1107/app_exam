...
/**
 * Created by 501-03 on 2018-03-13.
 */
...
public class MyItemAdapter extends BaseAdapter {
    ...
    LayoutInflater inflater;  // 항목을 표현하는 객체
    Context context;  // MainActivity의 정보를 저장하는 변수
    int item_layout;  // 항목의 레이아웃 아이디

    public MyItemAdapter(ArrayList<MainActivity.Item_dataFormat> arrayList, Context context, int item_layout) {
    ...
    * */
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        // 항목에 들어가는 컴포넌트의 객체
        ImageView img=(ImageView)view.findViewById(R.id.imageView_ThumbNail_main);
        TextView title=(TextView)view.findViewById(R.id.textView_Title_main);
        TextView subTitle=(TextView)view.findViewById(R.id.textView_subTitle_main);
